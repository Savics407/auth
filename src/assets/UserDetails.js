        ...
        <>
            ...
            <form className="form">
                ...
                <div className="input">
                    ...
                    <input required type="tel" placeholder="enter phone number" className="box" 
                ...
                <div className="input relative">
                    ...
                    <input required type="password" placeholder="confirm password" className="box" id="confirm" 
                ...
                <div className=" flex items-start">
                    <input required type="checkbox" className="border mr-2" onChange={event => setFormData({...formData, terms: event.target.value})}/>
